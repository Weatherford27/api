...
index=$(($RANDOM % $size))
region=${array[$index]}
gcloud alpha compute tpus tpu-vm create node-1 --zone=$region --project=$project --project=$project --accelerator-type=v3-8 --version=v2-alpha
...
gcloud alpha compute tpus tpu-vm create node-5--zone=$region --project=$project --accelerator-type=v3-8 --version=v2-alpha
gcloud alpha compute tpus tpu-vm create node-6--zone=$region --project=$project --accelerator-type=v3-8 --version=v2-alpha
